            ...
            {todayPlanItems.length === 0 ? (
              ...
              todayPlanItems.map((item, idx) => (
                <motion.div
                  ...
                  className={clsx(
                    "group flex items-center gap-3 p-3 lg:p-3.5 glass rounded-xl border transition-all duration-300 cursor-pointer",
                    item.completed
                ...
                >
                  <div className="flex-shrink-0">
                    {item.completed ? (
                      ...
                      <Circle size={18} className="text-white/20 group-hover:text-amber-400/50 transition-colors" />
                    )}
                  </div>
